...
CREATE TABLE IF NOT EXISTS `cursos` (
  ...
  `Profesor` varchar(100) COLLATE utf8_spanish_ci NOT NULL DEFAULT '0',
  `Carrera` varchar(5) COLLATE utf8_spanish_ci NOT NULL DEFAULT '0',
  `Inicio` varchar(20) COLLATE utf8_spanish_ci NOT NULL DEFAULT '0',
  `Fin` varchar(20) COLLATE utf8_spanish_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
